...
import { mergedAuthAndUserData, existingUserTwo } from '@root/mocks/user.mock';
...
export const messageDataMock: IMessageData = {
  ...
  senderUsername: mergedAuthAndUserData.username!,
  senderId: `${mergedAuthAndUserData._id}`,
  senderAvatarColor: mergedAuthAndUserData.avatarColor!,
  senderProfilePicture: mergedAuthAndUserData.profilePicture,
